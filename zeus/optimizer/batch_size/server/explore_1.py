...
class PruningExploreManagerr(object):
    ...
    async def next_batch_size(
        ...
        if trial == 0:
            ...
            if next_batch_size == -1:
                ...
                trial += 1
                PruningExploreManagerr._log(f"Going to next trial({trial})")
    ...
    async def report_batch_size_result(
        ...
        PruningExploreManagerr._log(f"Update exploration for {bs.batch_size}.")
