...
from zeus.monitor.price import EnergyCostMonitor, OpenEIClient
...
def main():
    ...
    # initialize EnergyCostMonitor
    ip_latlong = get_ip_lat_long()
    electricity_price_provider = OpenEIClient(ip_latlong, estimate=True)
    monitor = EnergyCostMonitor(electricity_price_provider)
    ...
    if training_args.do_train:
        ...
        train_measurement = monitor.end_window("train")
    ...
    if training_args.do_eval:
        ...
        eval_measurement = monitor.end_window("eval")
    ...
    if train_measurement is not None:
        print("Train electricity cost measurements:")
        print(train_measurement)
    if eval_measurement is not None:
        print("Evaluation electricity cost measurements:")
