...
def infer_counter_update_period(gpu_indices: list[int]) -> float:
    """Infer the update period of the power counter.
...
def _infer_counter_update_period_single(gpu_index: int) -> float:
    """Infer the update period of the power counter for a single GPU."""
